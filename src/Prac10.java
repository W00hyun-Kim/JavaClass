...
public class Prac10 {
	public static void main(String[] args) throws IOException {
		...
		File k6_f1 = new File("D:\\test\\20150112.csv");
		...
		while ((k6_readtxt = k6_br.readLine()) != null) { // 한줄 씩 읽기
			...
			//한 줄에 20150112가 포함된 경우(20150112 날짜인 경우) 그 줄을 전부 Stringbuffer로 붙인다.
			if (k6_readtxt.contains("20150112")) {
